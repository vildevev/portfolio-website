		...
		<!-- Contact -->
			<section id="contact" class="main style3 secondary">
				<div class="content">
					<header>
						<h2>Say Hello.</h2>
						<p>I would love to meet up to talk possible career oppurtunities. Let's grab some matcha (or whatever hip drink people are currently into at the moment).</p>
					</header>
					<div class="box">
			...
			<footer id="footer">
				...
				<!-- Icons -->
					<ul class="actions">
						...
						<li><a href="https://www.linkedin.com/in/vilde-vevatne/" class="icon fa-linkedin"><span class="label">LinkedIn</span></a></li>
						<li><a href="https://github.com/vildevev" class="icon fa-github"><span class="label">Dribbble</span></a></li>
						<!-- <li><a href="#" class="icon fa-pinterest"><span class="label">Pinterest</span></a></li> -->
					</ul>

				<!-- Menu -->
					<ul class="menu">
						<li>&copy; Vilde Vevatne</li>
					</ul>
